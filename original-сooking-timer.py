...
class TimerApp:
    def __init__(self, root):
        ...
        for i in range(2):
            for j in range(2):
                frame = tk.Frame(root, bg="#e0f7fa", bd=2, relief="groove")
    ...
    def create_timer(self, parent, name):
        ...
        timer_frame = tk.Frame(parent, bg="#e0f7fa")
        timer_frame.pack(expand=True, fill="both", padx=5, pady=5)
 
        
        label = tk.Label(timer_frame, text=name, font=("Arial", 12), bg="#e0f7fa", fg="#00796b")
        label.pack(pady=5)
 
       
        top_frame = tk.Frame(timer_frame, bg="#e0f7fa")
        ...
        mid_frame = tk.Frame(timer_frame, bg="#e0f7fa")
        ...
        bottom_frame = tk.Frame(timer_frame, bg="#e0f7fa")
