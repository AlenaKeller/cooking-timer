...
class TimerApp:
    ...
    def create_timer(self, parent, name):
        ...
        label = tk.Label(timer_frame, text=name, font=("Arial", 12), bg="white", fg="black")
        label.pack(pady=5)
 
       
        top_frame = tk.Frame(timer_frame, bg="white")
        ...
        mid_frame = tk.Frame(timer_frame, bg="white")
        ...
        bottom_frame = tk.Frame(timer_frame, bg="white")
    ...
    def flash_alert(self, timer_data):
        ...
        new_color = "white" if current_color == "#a5d6a7" else "#a5d6a7"
